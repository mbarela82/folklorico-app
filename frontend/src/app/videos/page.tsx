...
function VideoContent() {
  ...
  const [folderToDeleteId, setFolderToDeleteId] = useState<number | null>(null); // NEW
  ...
  return (
    <div className="flex-1 p-4 md:p-8 overflow-y-auto h-full pb-24 md:pb-8">
      ...
      <ConfirmationModal
        ...
        title="Delete Video?"
        message="This will remove the file permanently."
        type="danger"
      ...
      <ConfirmationModal
        ...
        title="Delete Folder?"
        message="Are you sure? Videos inside this folder will remain but lose their region assignment."
        type="danger"
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-bold flex items-center gap-2">
              ...
              {isFolderView ? "Video Library" : selectedRegionName}
            </h1>
          </div>
            ...
            <>
              ...
              {filteredItems.length === 0 ? (
                <div className="h-64 border border-dashed border-zinc-800 rounded-2xl flex flex-col items-center justify-center text-zinc-500 gap-4">
                  ...
                  <p>No videos found in {selectedRegionName}.</p>
                </div>
              ) : (
                /* Videos: 1-col on Mobile (List), 3-col on Laptop, 4-col on XL */
