...
export default function DrawerBookmarkContent({
  // add form
  isAddingMark,
  newMarkNote,
  onChangeNewMarkNote,
  ...
  onJumpAndClose: (time: number) => void;
  ...
  return (
    <>
      {isAddingMark && (
        <div className="mb-4 bg-black/40 p-3 rounded-lg border border-indigo-500/40 animate-in fade-in slide-in-from-top-2">
          <input
            autoFocus
            type="text"
            placeholder="Note..."
            ...
            >
              <div
                className={`w-4 h-4 border rounded flex items-center justify-center ${
                  isNewMarkPublic ? "bg-amber-500 border-amber-500" : "border-white/30"
                }`}
              >
