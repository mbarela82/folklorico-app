...
export default function MediaCard({
  ...
  return (
    <div
      onClick={onClick}
      className="group relative bg-zinc-900/50 border border-zinc-800 p-3 rounded-xl hover:bg-zinc-900 hover:border-indigo-500/50 transition-all cursor-pointer flex items-start gap-4"
    >
      {/* THUMBNAIL AREA */}
